    ...
    <div className="min-h-screen bg-background py-32">
      <div className="container mx-auto px-6 max-w-4xl text-center">
        <div className="bg-card rounded-2xl shadow-lg p-12">
          ...
          <button
            onClick={() => router.back()}
            className="bg-primary hover:bg-primary-hover text-white font-semibold py-3 px-6 rounded-xl transition-colors duration-300 flex items-center justify-center gap-2 mx-auto"
          >
  ...
  <div className="min-h-screen bg-background pt-32 pb-20">
    <div className="container mx-auto px-6 max-w-4xl">
      ...
      <div className="mb-8">
        <button
          onClick={() => router.back()}
          className="flex items-center gap-2 p-2 rounded-lg text-primary hover:text-primary-hover font-medium transition-colors duration-300"
        >
          <ArrowLeft className="w-5 h-5" />
          <span>Back to Articles</span>
        </button>
      ...
      {/* Article Header */}
      <div ref={headerRef} className="bg-card rounded-2xl shadow-lg p-8 mb-8">
        <div className="flex flex-wrap gap-2 mb-4">
          {article.tags && article.tags.map((tag, index) => (
            <span
              key={index}
              className="inline-flex items-center px-3 py-1 text-sm font-medium bg-muted text-primary rounded-full"
            >
      ...
      {/* Article Content */}
      <div ref={contentRef} className="bg-card rounded-2xl shadow-lg p-8 mb-12">
